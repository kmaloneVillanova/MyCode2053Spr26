...
# comprehension iterates through an existing list or sequence
# to make a new list
# comprehensions can also use a conditional like if animal=='dog'
animals = ['dog','cat','dog','turtle']
# create a new list 'dogs' from the list animals with only dog elements 
